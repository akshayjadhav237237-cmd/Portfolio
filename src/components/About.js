    ...
    <div className='about-container' id="about">
      ...
      <div className='about-text-container'>
        <div className='about-text'>
          ...
          <div className='resume-btn'><a href='https://drive.google.com/file/d/1ZVB19GwAwSj7UQ9my98PNTIrimUhc7g5/view?usp=sharing' target="_blank" className='text-gradient'>Resume</a></div>
        </div>
